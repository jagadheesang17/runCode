...
test.describe(`Verify People Admin Group Module Access and User Management Features`, async () => {
    test.describe.configure({ mode: 'serial' })
    test(`Verify whether the users attached to the People Admin `, async ({ adminHome, createUser ,createCourse,adminGroup}) => {
        test.info().annotations.push(
            { type: `Author`, description: `Divya` },
            { type: `TestCase`, description: `Verify whether the users attached to the People Admin` },
            { type: `Test Description`, description: `Verify whether the users attached to the People Admin` }
        );
    ...
    test(`Verify whether the users attached to the People Admin Group can see only the People Module`, async ({ adminHome, adminGroup,learnerHome, createUser}) => {
