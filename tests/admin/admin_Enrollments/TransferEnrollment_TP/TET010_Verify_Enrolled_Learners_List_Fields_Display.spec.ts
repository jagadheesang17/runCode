...
test.describe(`TE010 - Verify LP version management with enrollment status transfer`, () => {
    ...
    test(`Creation of E-learning courses`, async ({ adminHome, createCourse }) => {
        test.info().annotations.push(
            ...
            { type: `TestCase`, description: `TE010 - Create two courses` },
            { type: `Test Description`, description: `Create two E-learning courses for Learning Path via API` }
        );
    ...
    test(`Create Learning Path and enroll 5 users`, async ({ adminHome, learningPath, createCourse, enrollHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `TE010 - Create LP and enroll users` },
            { type: `Test Description`, description: `Create Learning Path with course 1 and enroll 5 users` }
        );
    ...
    test(`User 1 completes and User 2 sets to In Progress`, async ({ catalog, learnerHome, createUser, dashboard }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `TE010 - Learner actions` },
    ...
    test(`Admin updates status - User 5: Completed, User 3: Canceled, User 4: remains Enrolled`, async ({ adminHome, enrollHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `TE010 - Admin status updates` },
    ...
    test(`Create Version 2 with additional course and transfer learners`, async ({ adminHome, learningPath, createCourse, enrollHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `TE010 - Create Version 2 and transfer` },
        ...
        console.log(`✅ Version 2 created successfully: ${lpTitleVersion2}`);
    ...
    test(`Verify all users status in Version 2 - Completed users become In progress`, async ({ adminHome, enrollHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `TE010 - Verify status after transfer` },
