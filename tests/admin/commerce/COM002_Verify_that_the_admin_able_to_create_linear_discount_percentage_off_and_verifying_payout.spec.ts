...
test(`Verify that the admin able to create linear discount with percentage off`, async ({ adminHome, commercehome, createCourse, discount, SurveyAssessment }) => {
   ...
   // await discount.selectVolumeDiscount();
    ...
    dicountValue = await discount.setDiscountRules("Percentage Off");
