...
test.describe(`SO001_Verify_admin_can_choose_multiple_training_and_purchase_for_single_learner`, () => {
    ...
    test(`Test 1: Verify admin can select Certification training for single learner`, async ({ adminHome, enrollHome, costCenter, commercehome, learningPath, createCourse, editCourse }) => {
        ...
        await enrollHome.selectBycourse(certificationName, "paid");
        ...
        await commercehome.validateInvoice(certificationName);
    });
