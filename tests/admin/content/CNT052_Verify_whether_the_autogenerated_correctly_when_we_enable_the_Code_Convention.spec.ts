...
test.describe(`Verify whether unable to edit the published content's code for the versioned content when code convention in enabled`, async () => {
    ...
    test(`Verify whether the autogenerated correctly when we enable the Code Convention`, async ({ adminHome, contentHome, bannerHome, createCourse, adminGroup, siteAdmin }) => {
        ...
        await contentHome.verifyFieldIsDisabled("//input[@id='content_code']");
