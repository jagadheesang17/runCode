...
test(`Verify whether the content has been created and added to the course `, async ({ adminHome, contentHome, bannerHome, createCourse, enrollHome }) => {
    ...
    await contentHome.selectLearnerStatus('Enrolled');
...
test(`Verify that the transferred content available in the course details page and verify able to launch and complete the course `, async ({ learnerHome, catalog }) => {
           ...
           await catalog.verifyContentProgressValue(newTitle,"100%");
