...
test.describe(`Verify manager approved ILT course without price`, async () => {
    test.describe.configure({ mode: 'serial' })
    
    test(`Create ILT course with Manager Approval Enabled`, async ({ adminHome, createCourse, editCourse }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Create ILT course with Manager Approval Enabled` },
            { type: `Test Description`, description: `Create ILT course with Manager Approval Enabled` }
        );
        ...
        await createCourse.typeDescription("This is a new ILT course by name: " + courseName);
    ...
    test(`Ensure that a learner is able to register for ILT course that requires manager approval`, async ({ learnerHome, catalog }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Ensure that a learner is able to register for ILT course that requires manager approval` },
            { type: `Test Description`, description: `Ensure that a learner is able to register for ILT course that requires manager approval` }
        );
    ...
    test(`Ensure that the manager is able to successfully approve the ILT request`, async ({ learnerHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Ensure that the manager is able to successfully approve the ILT request` },
            { type: `Test Description`, description: `Ensure that the manager is able to successfully approve the ILT request` }
        );
