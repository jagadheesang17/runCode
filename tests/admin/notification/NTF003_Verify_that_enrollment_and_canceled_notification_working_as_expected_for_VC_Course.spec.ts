...
test.describe(`Verify that enrollment notification working as expected for VC course`, async () => {
    test.describe.configure({ mode: "serial" });

    test(`Creation of Multi instance VC course`, async ({ adminHome, contentHome, createUser, createCourse }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Creation of Multi instance VC course` },
            { type: `Test Description`, description: `Creation of Multi instance VC course` }
        );
