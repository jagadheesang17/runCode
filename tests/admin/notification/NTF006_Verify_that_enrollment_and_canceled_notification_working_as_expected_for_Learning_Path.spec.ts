...
test.describe(`Verify that enrollment and Canceled notification working as expected for Learning Path`, async () => {
    ...
    test(`Confirm that a learner can successfully register for created Learning path`, async ({ learnerHome, catalog }) => {

        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Confirm that a learner can successfully register for created Learning path` },
            { type: `Test Description`, description: `Confirm that a learner can successfully register for created Learning path` }
    ...
    test(`Test to execute CRON JOB for Canceled`, async ({ adminHome }) => {
        ...
        await adminHome.verifyMailBody(mailBody, title)
        await adminHome.verifyMailSubject(mailSubject, "cancel")
    })
