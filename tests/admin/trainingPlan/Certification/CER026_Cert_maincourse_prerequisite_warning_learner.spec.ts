...
test.describe(`Verify_the_warning_message_when_the_learner_try_to_enroll_the_maincourse_before_did_not_complete_the_prerequisite_and_complete_maincourse_after_completing_the_course's_prerequisites_in_certification`, async () => {
    ...
    test(`Attaching the main course which having pre requisite to certification `, async ({ adminHome, learningPath, createCourse, editCourse, enrollHome, catalog }) => {
    ...
    test(`Attaching the main course which having pre requisite to certification and verify the popup message when the learner try to enroll the main course without completing the prerequisite after enrolling the certification`, async ({ learnerHome, catalog, dashboard }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Verify learner able to launch certification level Prerequisite course and  complete it` },
            { type: `Test Description`, description: `Verify learner able to launch certification level Prerequisite course and  complete it` }
