...
let tag: any
test.describe(`Verify_the_Pre_Requisite_behaviour_in_Learner_side_if_Pre_requisites_are_attached_at_course_and_certification_level`, async () => {
    ...
    test(`Attaching the main course which is having pre requisite and separate pre requisite to certification`, async ({ learnerHome, adminHome, learningPath, createCourse, catalog, enrollHome }) => {
    ...
    test(`Verify that the popup msg when learner try to complete the main course which is having prerequisite courses after completing the prerequisite courses which is attached to the certification `, async ({ learnerHome, catalog, dashboard }) => {
        ...
        await catalog.verifyPrerequisiteMandatoryMessage("Certification")
