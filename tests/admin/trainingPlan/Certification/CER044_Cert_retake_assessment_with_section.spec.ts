...
test.describe(`Verify_that_the_learner_can_retake_the_assessment_after_failing_it_in_the_first_attempt_for_a_section_level_assessment`, async () => {
    ...
    test(`Verify that the learner can retake the assessment after failing it in the first attempt for a with section level assessment and also with feedback `, async ({ learnerHome, catalog, dashboard }) => {
