...
test.describe(`Verify_the_Multi_Instance_coutrse_status_when_those_are_attached_to_the_certification_and_when_the_admin_enrolls_the_certification`, () => {
  ...
  test(`Creation of Certification and attach that created multi-instance courses`, async ({ adminHome, learningPath, createCourse, editCourse }) => {
