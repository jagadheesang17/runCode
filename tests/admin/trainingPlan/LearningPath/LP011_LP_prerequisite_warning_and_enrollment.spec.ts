...
test.describe(`Verify_the_warning_message_when_the_admin_try_to_enroll_the_learningplan_before_did_not_complate_the_prerequisite_and_enroll_learningpath_after_completing_the_prerequisites`, async () => {
...
test(`Verify the admin able to add 2 prerequisites and main course to the learnin path and verify the popup message when the admin try to enroll lp without completing the 2 pre requisites`, async ({ adminHome, learningPath, createCourse, enrollHome, catalog }) => {
    ...
    // await catalog.verifyPrerequisiteMandatoryMessageFromAdmin("Training Plan");
