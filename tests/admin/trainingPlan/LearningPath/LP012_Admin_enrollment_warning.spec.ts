...
let tag: any
test.describe(`Verify_the_warning_message_when_the_admin_try_to_enroll_the_maincourse_before_did_not_complate_the_prerequisite_and_complete_maincourse_after_completing_the_course's_prerequisites`, async () => {
    ...
    test(`Attaching the main course which having pre requisite to lp and verify the popup message when the admin try to enroll the main course without completing the prerequisite after enrolling the tp`, async ({ adminHome, learningPath, createCourse, editCourse, enrollHome, catalog }) => {
