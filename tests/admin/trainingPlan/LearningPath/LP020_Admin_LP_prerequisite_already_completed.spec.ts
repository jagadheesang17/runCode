...
test.describe(`Verify_if_the_learner_already_completed_the_course_attached_as_lp_prerequisite_and_completed_status_reflected_when_the_learner_enrolls_lp_without_warning_popup`, async () => {
    ...
    test(`Creation of Single Instance and prerequisite course for lp`, async ({ adminHome, editCourse, createCourse }) => {
 ...
 await adminHome.loadAndLogin("CUSTOMERADMIN")
    ...
    test(`admin who complete the prerequisite course before attaching it to lp`, async ({ adminHome, learningPath, createCourse, editCourse, enrollHome, catalog }) => {
    ...
    test(`Verify the reflection of prereq's completed status when admin enrolls in learning path without warning popup`, async ({ adminHome, learningPath, createCourse, editCourse, enrollHome, catalog }) => {
