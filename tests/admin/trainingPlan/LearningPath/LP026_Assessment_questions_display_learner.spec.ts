...
test.describe(`TP039_Verify_that_the_created_assessment_questions_are_displayed_on_the_course_details_page_for_the_learner_after_completing_the_content.spec`, async () => {
    ...
    test(`Verify that created assessment questions are displayed on the course details page for the learner after enrolling the course`, async ({ learnerHome, catalog }) => {
