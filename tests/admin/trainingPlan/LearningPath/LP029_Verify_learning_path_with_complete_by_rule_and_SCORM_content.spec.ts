...
test.describe(`TP040_Verify_learning_path_with_complete_by_rule_and_SCORM_content.spec.ts`, async () => {
    test.describe.configure({ mode: "serial" });

    test(`Create single instance E-Learning course with SCORM 2004 content`, async ({ adminHome, createCourse }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Create E-Learning course with SCORM 2004 content` },
            { type: `Test Description`, description: `Create a single instance E-Learning course with SCORM 2004 Passed-Failed content to be added to learning path` }
        );
    ...
    test(`Create simple learning path with Complete by Rule and attach SCORM course`, async ({ adminHome, learningPath, createCourse }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `TP040 - Create learning path with Complete by Rule and SCORM content` },
            { type: `Test Description`, description: `Admin creates a simple learning path with Complete by Rule enabled and attaches SCORM content course` }
        );
        ...
        console.log(`🔄 Attaching SCORM course to learning path`);
        // Attach course
        ...
        console.log(`✅ Successfully created learning path with Complete by Rule: ${learningPathTitle}`);
        console.log(`   Attached course: ${courseName} (SCORM 2004)`);
    });

    test(`Verify learner can enroll and complete learning path with SCORM content`, async ({ learnerHome, catalog, readContentHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Verify learner side enrollment and completion` },
            { type: `Test Description`, description: `Learner enrolls in learning path, launches SCORM content, completes it, and verifies completion` }
        );
        ...
        console.log(`✅ Learning path with Complete by Rule and SCORM content completed successfully`);
    });

    test(`Verify Complete by Rule date is enforced`, async ({ learnerHome,catalog, dashboard }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Verify Complete by Rule enforcement` },
