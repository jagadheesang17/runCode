...
let tag: any
test.describe(`Verify_the_admin_created_learning_Path_with_Pre-Requisite_at_TP_level_and_course_level`, async () => {
    ...
    test(`Verify that the popup msg when admin try to complete the main course which is having prerequisite courses after completing the prerequisite courses which is attached to the TP`, async ({ adminHome, learningPath, createCourse, editCourse, enrollHome, catalog }) => {
