...
test.describe(`TP035_Create_3_multi_instance_courses_and_attach_to_learning_path.spec.ts`, async () => {
    ...
    const learningPathTitle = ("Multi-Instance LP " + FakerData.getCourseName());

    test(`Create learning path and attach all 3 multi-instance courses`, async ({ adminHome, learningPath, createCourse }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Create learning path with 3 multi-instance courses` },
            { type: `Test Description`, description: `Create learning path and attach all 3 multi-instance courses (Classroom, E-Learning, Virtual Class)` }
        );
        ...
        await learningPath.description("Learning path with 3 multi-instance courses: " + description);
        ...
        console.log("✅ Added first multi-instance course to learning path: " + courseName1);
        ...
        console.log("✅ Learning path created successfully with 3 multi-instance courses: " + learningPathTitle);
    });

    test(`Verify learning path with multi-instance courses in catalog`, async ({ learnerHome, catalog }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Verify learning path with multi-instance courses appears in catalog` },
            { type: `Test Description`, description: `Verify that the learning path containing 3 multi-instance courses is visible in catalog and can be enrolled` }
        );
        ...
        try {
            ...
            console.log("✅ Successfully enrolled in learning path with multi-instance courses");
        ...
        console.log("   ✓ Attached all courses to learning path: " + learningPathTitle);
        console.log("   ✓ Learning path available in catalog for enrollment");
        console.log("✅ TP035 TEST CASE COMPLETED SUCCESSFULLY");
        console.log("🎯 RESULT: 3 multi-instance courses successfully created and attached to learning path");
    });
});