...
test.describe(`TP036_Verify_mandatory_learning_path_multiple_groups_and_users.spec.ts`, async () => {
    ...
    test(`Create E-learning single instance course for mandatory access testing`, async ({ adminHome, createCourse }) => {
        test.info().annotations.push(
            ...
            { type: `Test Description`, description: `Create single instance course that will be used in learning path for mandatory access with multiple groups` }
        );
    ...
    test(`Create learning path with mandatory access for multiple learner groups and users`, async ({ adminHome, learningPath, createCourse }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Create learning path with mandatory access for multiple groups` },
            { type: `Test Description`, description: `Create learning path and configure mandatory access for two learner groups with multiple users` }
        );
        ...
        await createCourse.verifySuccessMessage();
        console.log("✅ Learning path created with mandatory access for multiple groups and users");
    });

    test(`Run auto register cron job and verify learning path is auto-enrolled for multiple users`, async ({ adminHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Execute auto register cron for multiple users` },
            { type: `Test Description`, description: `Run auto register cron job and verify that learning path is auto-enrolled for all users in multiple groups` }
        );
    ...
    test(`Verify mandatory learning path is auto-enrolled for User1 (in both groups)`, async ({ dashboard, learnerHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Verify User1 auto-enrollment due to mandatory access` },
            { type: `Test Description`, description: `Verify that User1 (member of both groups) has the learning path auto-enrolled` }
        );
        ...
        try {
            ...
            console.log(`✅ SUCCESS: Learning path was auto-enrolled for User1: ${user1}`);
        } catch (error) {
            console.log(`❌ FAILURE: Learning path was NOT auto-enrolled for User1: ${user1}`);
            throw new Error(`Learning path should be auto-enrolled for User1 with mandatory access`);
        }
    });

    test(`Verify mandatory learning path is auto-enrolled for User2 (in one group)`, async ({ dashboard, learnerHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Verify User2 auto-enrollment due to mandatory access` },
            { type: `Test Description`, description: `Verify that User2 (member of learner group 2 only) has the learning path auto-enrolled` }
        );
        ...
        try {
            await dashboard.searchCertification(title);
            console.log(`✅ SUCCESS: Learning path was auto-enrolled for User2: ${user2}`);
        } catch (error) {
            console.log(`❌ FAILURE: Learning path was NOT auto-enrolled for User2: ${user2}`);
            throw new Error(`Learning path should be auto-enrolled for User2 with mandatory access`);
        }
    });

    test(`Verify User1 cannot cancel mandatory learning path enrollment`, async ({ catalog, learnerHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Verify User1 cannot cancel mandatory learning path` },
            { type: `Test Description`, description: `Verify that User1 cannot cancel enrollment for mandatory learning path` }
        );
        ...
        try {
            ...
            console.log(`✅ Mandatory learning path found in My Learning for User1: ${user1}`);
            ...
            try {
                ...
                throw new Error(`Mandatory learning path should NOT allow cancellation for User1`);
            } catch (cancelError) {
            ...
            console.log(`⚠️ Learning path may not be visible for User1 or there was an issue accessing it`);
        }
    });

    test(`Verify User2 cannot cancel mandatory learning path enrollment`, async ({ catalog, learnerHome }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Tamilvanan` },
            { type: `TestCase`, description: `Verify User2 cannot cancel mandatory learning path` },
            { type: `Test Description`, description: `Verify that User2 cannot cancel enrollment for mandatory learning path` }
        );
        ...
        try {
            // Try to find and click the learning path
            await catalog.verifyEnrolledCourseByTitle(courseName);
            console.log(`✅ Mandatory learning path found in My Learning for User2: ${user2}`);

            // Attempt to cancel enrollment (this should fail or not be available)
            try {
                await catalog.mylearningMandatoryClassCancel();
                console.log(`❌ FAILURE: Cancel enrollment option was available for User2: ${user2}`);
                throw new Error(`Mandatory learning path should NOT allow cancellation for User2`);
            } catch (cancelError) {
                if (cancelError.message.includes("should NOT allow cancellation")) {
                    throw cancelError;
                }
            ...
            console.log(`⚠️ Learning path may not be visible for User2 or there was an issue accessing it`);
        }
    });
});