...
test.describe(`Verify_the_pre_and_post_assessment_score_in_manage_enrollment_side_after_the_admin_complete_the_course.spec`, async () => {
 ...
 //let title="Primary Microchip Bypass";
    ...
    test(`Getting the score from the assessments`, async ({ learnerHome, catalog }) => {
    ...
    test(`Verify that the pre and post assessment scores are correctly displayed in the manage enrollment side after the admin completes the course`, async ({ learnerHome, catalog,adminHome ,enrollHome}) => {
