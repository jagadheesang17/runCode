...
test(`LP Creation with that created survey`, async ({ adminHome, learningPath, createCourse, createUser }) => {
    test.info().annotations.push(
        { type: `Author`, description: `Jagadish` },
...
test(`Verify that the created survey questions are displayed on the course details page for the learner after completing the content`, async ({ learnerHome, catalog }) => {
