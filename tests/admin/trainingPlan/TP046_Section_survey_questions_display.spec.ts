...
test.describe(`Verify_that_the_created_survey_questions_within_the_section_are_displayed_on_the_course_details_page_for_the_learner_after_completing_the_content`, async () => {
    ...
    test(`Attaching the created survey to the learning path`, async ({ adminHome, learningPath, createCourse, createUser }) => {
        test.info().annotations.push(
            { type: `Author`, description: `Jagadish` },
    ...
    test(`Verify that the created survey questions within the section are displayed on the course details page for the learner after completing the content`, async ({ learnerHome, catalog }) => {
