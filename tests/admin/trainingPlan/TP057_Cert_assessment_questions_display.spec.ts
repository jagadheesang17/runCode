...
test.describe(`TP057_Verify_that_the_created_assessment_questions_are_displayed_on_the_course_details_page_for_the_learner_after_completing_the_content_in_certification.spec`, async () => {
    ...
    test(`Creation of Pre-Assessment`, async ({ adminHome, SurveyAssessment }) => {
        ...
        await SurveyAssessment.checkRequired("3");
    ...
    test(`Verify that created assessment questions are displayed on the course details page for the learner after enrolling the certification`, async ({ learnerHome, catalog, dashboard }) => {
            ...
            await catalog.verifyAssessmentQuestions([question1, question2, question3], "Pre-Assessment");
            ...
            await catalog.verifyAssessmentQuestions([question4, question5, question6], "Post-Assessment");
