...
test.describe(`Verify_the_CEU_which_is_inherited_from_course_to_certification_and_update_and_verify_them_from_learnerside_after_enrollmengt`, async () => {
    ...
    test(`Verify that updated CEU unit in course details page from the learner side`, async ({ learnerHome, catalog, dashboard }) => {
