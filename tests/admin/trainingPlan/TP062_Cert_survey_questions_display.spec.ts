...
test.describe(`Verify_that_the_created_survey_questions_are_displayed_on_the_course_details_page_for_the_learner_after_completing_the_content`, async () => {
    test.describe.configure({ mode: 'serial' })
test(`Creating the survey with questions.spec.ts`, async ({ adminHome, SurveyAssessment }) => {
    test.info().annotations.push(
        { type: 'Author', description: 'Balsundar' },
...
test(`Certification Creation with that created survey`, async ({ adminHome, learningPath, createCourse, createUser }) => {
    test.info().annotations.push(
        { type: `Author`, description: `Jagadish` },
...
test(`Verify that the created survey questions are displayed on the course details page for the learner after completing the content`, async ({ learnerHome, catalog, dashboard }) => {
